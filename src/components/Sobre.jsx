...
export function Sobre() {
  return (
    <div className="max-w-7xl px-12 mx-auto text-center py-12 text-gray-100 space-y-12">
      <h2 className="font-bold text-4xl text-violet-700 flex justify-center gap-2">
